    ...
    <article class={styles.preface}>
      <div ref={bindBody} class={styles.body}>
        ...
        <section id="ecosystem" class={styles.section} data-reveal>
          ...
          <Prose>
            技术层面上，基模厂商基本上都已经适配到了 100M 上下文，omini 全模态模型开始流行（minimax-h3 已支持全模态输入和输出的能力），能力上思考模式变成标配，Agentic 后训练也成为了每个厂商的技术博客中的常客。包括梁文峰投资人会议上一直在强调的大模型持续记忆能力，可能会成为下一个各大基模厂商押注的点。种种现象都在说明模型基座正在以每半年一个全新高度，甚至更快的速度全速狂奔中。
          </Prose>
          <Prose>
